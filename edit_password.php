...
if(isset($_POST['btnUpdate']))
  {
    ...
    $update="UPDATE tbluser SET username='$username', password='$new_pass' WHERE ID='$id'";
      //logs
...
<div class="row">
	...
	<form class="form-group" autocomplete="off" action="edit_password.php?id=<?php echo $user['ID'] ?>" method="POST">
